...
{  
    ...
    // And let it act. Same tag convention, same stripping; the difference is
    // that this one reaches mod-playerbots' command layer. Only offered when
    // the speaker is a real player the security model already trusts.
    prompt += Intent_BuildPrompt(bot, player);
